...
class WordleTests(unittest.TestCase):
    ...
    @parameterized.expand([
        ...
        ("FAVOR", "FAVOR", [], Status.LOSS, "It was FAVOR, better luck next time!", 6, 6),
        ...
        ("FAVOR", "TESTS", [], Status.LOSS, "It was FAVOR, better luck next time!", 5, 5),
        ("FAVOR", "TESTS", [], Status.LOSS, "It was FAVOR, better luck next time!", 7, 7),
